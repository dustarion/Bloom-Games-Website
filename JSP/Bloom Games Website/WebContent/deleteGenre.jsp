...
<html>
    ...
    <body>
        ...
        <div class="sidenav">
            ...
            <a class="active" href="deleteGenre.jsp"><i class="fas fa-trash"></i> Delete Genres</a>
        ...
        <div class="adminSection">
            ...
            <form class="mainFormCard" action="deleteGenreProcess.jsp">
                <!-- Select Game to Update -->
                <p>Select Genre to Delete</p>
                <div class="selectBox">
                    <select name="genreID">
